...
export default function Home() {
  // Modal.setAppElement('#root'); //la console m'a dit de faire ça mais ça ne marche plus, je ne sais pas pourquoi, pourtant l'id root est bien présent juste en dessous.
